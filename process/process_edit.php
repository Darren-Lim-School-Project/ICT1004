...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['acc_id'])) {
        ...
        echo "<a href='../myaccount.php'>Go to My Account Page...</a>";
    } else {
        echo "<h2>This page is not meant to be run directly.</h2>";
...
function saveMemberToDB() {
    ...
    if ($conn->connect_error) {
        ...
        if ($result->num_rows > 0) {
            ...
            $errorMsg = "Due to an unknown reason, you are unable to change your password. Please try again later.";
            $success = false;
        }
        $stmt->close();
    }
    ...
    <body>
        ...
        <main class="container">
            ...
            if ($success) {
                ...
                echo "<p>" . $errorMsg . "</p>";
                echo "<a class=\"btn btn-danger\" href=\"../myaccount.php\">Return to My Account</a>";
            }
            ?>
