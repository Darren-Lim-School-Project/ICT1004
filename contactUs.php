            ...
            <div class="w3-content">
                ...
                <form action="https://formspree.io/f/xpzolkro" id="test-form" method="POST">
                    ...
                    <form action="MailTo:stellayang23@hotmail.com"  method ="post" enctype="text/plain" target="_blank">
                        <p><input class="w3-input w3-padding-16 w3-border" type="text" value="<?php echo $_SESSION['fname']; ?>" name="Name" required></p>
                        <p><input class="w3-input w3-padding-16 w3-border" type="text" value="<?php echo $_SESSION['email']; ?>" name="Email" required></p>
